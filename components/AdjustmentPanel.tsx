...
const AdjustmentPanel: React.FC<AdjustmentPanelProps> = ({ onApplyAdjustment, isLoading }) => {
  ...
  const presets = [
    ...
    { name: 'Ánh sáng Studio', prompt: 'Add dramatic, professional studio lighting to the main subject.' },
  ];
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-center text-gray-300">Áp dụng Tùy chỉnh </h3>
      ...
      <input
        ...
        placeholder="Hoặc mô tả một tùy chỉnh (ví dụ: 'thay đổi nền thành màu xanh nước biển')"
