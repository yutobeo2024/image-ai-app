    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
          Chỉnh sửa ảnh bằng AI, <span className="text-cyan-400">BEO</span>.
        </h1>
        ...
        <div className="mt-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-blue-900/30 p-6 rounded-lg border border-blue-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-blue-800 rounded-full mb-4">
